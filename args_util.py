...
def parse_args(args):
    ...
    if config_dict["-e"] not in ["origin", "slice","slice_smote", "cc", "cc_smote","slice_bsmote", "slice_cvae", "slice_mixup","resampling", "undersampling", "fs", "cvae", "fs_cvae", "smote","bsmote", "mixup", "lda_cvae","lda_smote"]:
